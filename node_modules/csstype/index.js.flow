...
export type StandardProperties<TLength = string | 0> =
...
export type VendorProperties<TLength = string | 0> =
...
export type Properties<TLength = string | 0> =
...
export type VendorPropertiesHyphen<TLength = string | 0> =
...
export type JustifyTracksProperty =
    Globals
    | ContentDistribution
    | ContentPosition
    | "left"
