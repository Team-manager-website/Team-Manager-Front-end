...
cli
    ...
    .action(async (root, options) => {
        ...
        // is ok here
        const {createServer} = await import('./chunks/dep-ca21228b.js').then(function (n) {
            return n.E;
        });
        try {
...
cli
    ...
    .action(async (root, options) => {
        filterDuplicateOptions(options);
        const {build} = await import('./chunks/dep-ca21228b.js').then(function (n) {
            return n.D;
        });
...
cli
    ...
    .action(async (root, options) => {
        filterDuplicateOptions(options);
        const {optimizeDeps} = await import('./chunks/dep-ca21228b.js').then(function (n) {
            return n.C;
        });
        try {
...
cli
    ...
    .action(async (root, options) => {
        filterDuplicateOptions(options);
        const {preview} = await import('./chunks/dep-ca21228b.js').then(function (n) {
            return n.F;
        });
        try {
