    ...
    return function ssrPostTransformElement() {
        ...
        if (needMergeProps) {
            const {
                props,
                directives
            } = compilerDom.buildProps(node, context, node.props, false /* isComponent */, false /* isDynamicComponent */, true /* ssr */);
    ...
    return () => {
        ...
        if (tag) {
            ...
            const {
                props,
                directives
            } = compilerDom.buildProps(node, context, otherProps, true /* isComponent */, false /* isDynamicComponent */, true /* ssr (skip event listeners) */);
            let propsExp = null;
            if (props || directives.length) {
