                ...
                return o(this, function (o2) {
                    switch (o2.label) {
                        ...
                        case 2:
                            return o2.sent(), null !== d2.getItem(l2) ? [3, 5] : (u2 = this.id + "-" + t2 + "-" + i2, [4, a2(Math.floor(25 * Math.random()))]);
                        case 3:
                            return o2.sent(), d2.setItem(l2, JSON.stringify({
                                id: this.id,
                                iat: i2,
                                timeoutKey: u2,
...
var j = async (e, t, i, o, n, a2, s2 = 1e4) => n ? (async (e2, t2, i2, o2, n2, a3, s3) => {
    return r2 = {
        ...
        fetchOptions: o2,
        useFormData: s3
    }, c2 = a3, new Promise(function (e3, t3) {
        const i3 = new MessageChannel();
        i3.port1.onmessage = function (o3) {
            o3.data.error ? t3(new Error(o3.data.error)) : e3(o3.data), i3.port1.close();
        }, c2.postMessage(r2, [i3.port2]);
...
async function O(e, t) {
    var {baseUrl: i, timeout: o, audience: n, scope: a2, auth0Client: r2, useFormData: c2} = e,
        l2 = s(e, ["baseUrl", "timeout", "audience", "scope", "auth0Client", "useFormData"]);
    const d2 = c2 ? T(l2) : JSON.stringify(l2);
    return await async function (e2, t2, i2, o2, n2, a3, r3) {
        let c3, l3 = null;
        for (let s2 = 0; s2 < 3; s2++)
        ...
        if (l3)
            throw l3;
        const d3 = c3.json, {error: u2, error_description: h2} = d3,
            p2 = s(d3, ["error", "error_description"]), {ok: m2} = c3;
        if (!m2) {
            const t3 = h2 || `HTTP error. Unable to fetch ${e2}`;
            if ("mfa_required" === u2)
                throw new k(u2, t3, p2.mfa_token);
        ...
        return p2;
    }(`${i}/oauth/token`, o, n || "default", a2, {
        method: "POST",
        body: d2,
        headers: {
            "Content-Type": c2 ? "application/x-www-form-urlencoded" : "application/json",
            "Auth0-Client": btoa(JSON.stringify(r2 || p))
        }
    }, t, c2);
}
...
var W = class {
    ...
    async set(e) {
        var t;
        const i = new z({clientId: e.client_id, scope: e.scope, audience: e.audience}),
    ...
    matchExistingCacheKey(e, t) {
        return t.filter((t2) => {
            var i;
            const o = z.fromKey(t2), n = new Set(o.scope && o.scope.split(" ")),
                a2 = (null === (i = e.scope) || void 0 === i ? void 0 : i.split(" ")) || [],
                s2 = o.scope && a2.reduce((e2, t3) => e2 && n.has(t3), true);
            return "@@auth0spajs@@" === o.prefix && o.clientId === e.clientId && o.audience === e.audience && s2;
        })[0];
    }
};
...
var H = {
    get(e) {
        ...
        "https:" === window.location.protocol && (o = {
            secure: true,
            sameSite: "none"
        }), (null == i ? void 0 : i.daysUntilExpire) && (o.expires = i.daysUntilExpire), (null == i ? void 0 : i.cookieDomain) && (o.domain = i.cookieDomain), G(e, JSON.stringify(t), o);
    }, remove(e, t) {
        let i = {};
        (null == t ? void 0 : t.cookieDomain) && (i.domain = t.cookieDomain), J(e, i);
    }
...
var Y = {
    get: (e) => H.get(e) || H.get(`_legacy_${e}`), save(e, t, i) {
        let o = {};
        "https:" === window.location.protocol && (o = {secure: true}), (null == i ? void 0 : i.daysUntilExpire) && (o.expires = i.daysUntilExpire), (null == i ? void 0 : i.cookieDomain) && (o.domain = i.cookieDomain), G(`_legacy_${e}`, JSON.stringify(t), o), H.save(e, t, i);
    }, remove(e, t) {
        let i = {};
...
var D = ("", null, false, function (e) {
    return F = F || function (e2, t, i) {
        var o = void 0 === t ? null : t, n = function (e3, t2) {
            ...
            s2 = n.substring(a2) + (o ? "//# sourceMappingURL=" + o : ""),
...
var ee = class {
    ...
    async _prepareAuthorizeUrl(e, t, i) {
        const o = Z(S()), n = Z(S()), a2 = S(), s2 = ((e2) => {
            ...
            r2 = ((e2, t2, i2, o2, n2, a3, s3, r3) => Object.assign(Object.assign(Object.assign({client_id: e2.clientId}, e2.authorizationParams), i2), {
                scope: x(t2, i2.scope),
                response_type: "code",
                response_mode: r3 || "query",
                state: o2,
                nonce: n2,
                redirect_uri: s3 || e2.authorizationParams.redirect_uri,
                code_challenge: a3,
                code_challenge_method: "S256"
            }))(this.options, this.scope, e, o, n, s2, e.redirect_uri || this.options.authorizationParams.redirect_uri || i, null == t ? void 0 : t.response_mode),
    ...
    async loginWithPopup(e, t) {
        var i;
        if (e = e || {}, !(t = t || {}).popup && (t.popup = ((e2) => {
            const t2 = window.screenX + (window.innerWidth - 400) / 2,
                i2 = window.screenY + (window.innerHeight - 600) / 2;
            return window.open("", "auth0:authorize:popup", `left=${t2},top=${i2},width=400,height=600,resizable,scrollbars=yes,status=1`);
        })(), !t.popup))
            throw new Error("Unable to open a popup for loginWithPopup - window.open returned `null`");
        const o = await this._prepareAuthorizeUrl(e.authorizationParams || {}, {response_mode: "web_message"}, window.location.origin);
        ...
        }, {nonceIn: o.nonce, organizationId: a2});
    }
    ...
    async loginWithRedirect(e = {}) {
        var t;
        const i = q(e), {openUrl: o, fragment: n, appState: a2} = i, r2 = s(i, ["openUrl", "fragment", "appState"]),
            c2 = (null === (t = r2.authorizationParams) || void 0 === t ? void 0 : t.organization) || this.options.authorizationParams.organization,
            l2 = await this._prepareAuthorizeUrl(r2.authorizationParams || {}), {url: d2} = l2, u2 = s(l2, ["url"]);
        this.transactionManager.create(Object.assign(Object.assign(Object.assign({}, u2), {appState: a2}), c2 && {organizationId: c2}));
        const h2 = n ? `${d2}#${n}` : d2;
        o ? await o(h2) : window.location.assign(h2);
    }
    ...
    async handleRedirectCallback(e = window.location.href) {
        ...
        const {state: i, code: o, error: n, error_description: a2} = ((e2) => {
            ...
            return {
                state: t2.get("state"),
                code: t2.get("code") || void 0,
                error: t2.get("error") || void 0,
                error_description: t2.get("error_description") || void 0
            };
        })(t.join("")), s2 = this.transactionManager.get();
        if (!s2)
            throw new Error("Invalid state");
        ...
        return await this._requestToken(Object.assign({
            ...
            grant_type: "authorization_code",
            code: o
        }, l2 ? {redirect_uri: l2} : {}), {nonceIn: c2, organizationId: r2}), {appState: s2.appState};
    }
    ...
    async getTokenSilently(e = {}) {
        var t;
        const i = Object.assign(Object.assign({cacheMode: "on"}, e), {authorizationParams: Object.assign(Object.assign(Object.assign({}, this.options.authorizationParams), e.authorizationParams), {scope: x(this.scope, null === (t = e.authorizationParams) || void 0 === t ? void 0 : t.scope)})}),
            o = await ((e2, t2) => {
                let i2 = M[t2];
                return i2 || (i2 = e2().finally(() => {
                    delete M[t2], i2 = null;
    ...
    async _getTokenSilently(e) {
        ...
        if ("cache-only" !== t) {
            ...
            try {
                ...
                const e2 = this.options.useRefreshTokens ? await this._getTokenUsingRefreshToken(i) : await this._getTokenFromIFrame(i), {
                    id_token: o,
                    access_token: n,
                    oauthTokenScope: a2,
                    expires_in: s2
                ...
                return Object.assign(Object.assign({
                    id_token: o,
                    access_token: n
                }, a2 ? {scope: a2} : null), {expires_in: s2});
            } finally {
                await $.releaseLock("auth0.lock.getTokenSilently"), window.removeEventListener("pagehide", this._releaseLockOnPageHide);
            }
        }
    ...
    async _getTokenFromIFrame(e) {
        ...
        try {
            if (window.crossOriginIsolated)
                throw new g("login_required", "The application is running in a Cross-Origin Isolated context, silently retrieving a token without refresh token is not possible.");
            const t2 = e.timeoutInSeconds || this.options.authorizeTimeoutInSeconds,
                i2 = await ((e2, t3, i3 = 60) => new Promise((o2, n2) => {
                    const a3 = window.document.createElement("iframe");
                    a3.setAttribute("width", "0"), a3.setAttribute("height", "0"), a3.style.display = "none";
                    const s3 = () => {
                        window.document.body.contains(a3) && (window.document.body.removeChild(a3), window.removeEventListener("message", r3, false));
            ...
            if (n !== i2.state)
                throw new Error("Invalid state");
            const d2 = await this._requestToken(Object.assign(Object.assign({}, e.authorizationParams), {
                code_verifier: s2,
                code: i2.code,
                grant_type: "authorization_code",
                redirect_uri: r2,
    ...
    async _getEntryFromCache({scope: e, audience: t, clientId: i}) {
        ...
        if (o && o.access_token) {
            ...
            return n && Object.assign(Object.assign({
                id_token: n.id_token,
                access_token: e2
            }, t2 ? {scope: t2} : null), {expires_in: i2});
        }
    }
    ...
    async _requestToken(e, t) {
        ...
        }, e), this.worker), a2 = await this._verifyIdToken(n.id_token, i, o);
        return await this._saveEntryInCache(Object.assign(Object.assign(Object.assign(Object.assign({}, n), {
            decodedToken: a2,
            scope: e.scope,
            audience: e.audience || "default"
        }), n.scope ? {oauthTokenScope: n.scope} : null), {client_id: this.options.clientId})), this.cookieStorage.save(this.isAuthenticatedCookieName, true, {
            daysUntilExpire: this.sessionCheckExpiryDays,
            cookieDomain: this.options.cookieDomain
        }), this._processOrgIdHint(a2.claims.org_id), Object.assign(Object.assign({}, n), {decodedToken: a2});
    }
};
var te = class {
};
...
var ae = class {
    ...
    install(e) {
        ...
        })), this.__checkSession(e.config.globalProperties.$router), e.config.globalProperties.$auth0 = this, e.provide(a, this), ne.value = this;
    }
    ...
    async __checkSession(e) {
        ...
        const o = window.location.search;
        if ((o.includes("code=") || o.includes("error=")) && o.includes("state=") && !(null === (t = this.pluginOptions) || void 0 === t ? void 0 : t.skipRedirectCallback)) {
            const t2 = await this.handleRedirectCallback(), o2 = null == t2 ? void 0 : t2.appState,
                n = null !== (i = null == o2 ? void 0 : o2.target) && void 0 !== i ? i : "/";
            return window.history.replaceState({}, "", "/"), e && e.push(n), t2;
        }
        await this.checkSession();
    }
