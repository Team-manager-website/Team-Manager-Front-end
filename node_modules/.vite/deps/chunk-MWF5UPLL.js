...
var loopOverKeys = (body, allowVariableLoopVariable, {
    _,
    cnst,
    getFunctionIntro,
    s
}) => cnst !== "var" || allowVariableLoopVariable ? `for${_}(${cnst} k in e)${_}${body}` : `Object.keys(e).forEach(${getFunctionIntro(["k"], {
    isAsync: false,
    name: null
})}${body})${s}`;
...
var getWithToStringTag = (namespaceToStringTag, fragment, {
    _,
    getObject
}) => namespaceToStringTag ? `Object.defineProperty(${fragment},${_}Symbol.toStringTag,${_}${getToStringTagValue(getObject)})` : fragment;
...
var MetaProperty = class extends NodeBase {
    ...
    render(code, {format, pluginDriver, snippets}) {
        ...
        ]) || ((_a = importMetaMechanisms[format]) == null ? void 0 : _a.call(importMetaMechanisms, metaProperty, {
            chunkId,
            snippets
        }));
        if (typeof replacement === "string") {
...
${getCodeFrame(code, line, column)}`);
                    try {
                        const {
                            ...
                            line: originalLine
                        } = getOriginalLocation(module.sourcemapChain, {column, line});
...
function amd(magicString, {
    ...
    snippets,
    onwarn
}, {amd: amd2, esModule, externalLiveBindings, freeze, interop, namespaceToStringTag, strict}) {
...
function system(magicString, {
    ...
    let wrapperStart = `System.register(${registeredName}[` + dependencies.map(({importPath}) => `'${importPath}'`).join(`,${_}`) + `],${_}(${getNonArrowFunctionIntro(wrapperParameters, {
        ...
        isAsync: false,
        name: null
    })}{${n2}${t}${t}${t}${setter}${n2}${t}${t}}` : systemNullSetters ? `null` : `${getFunctionIntro([], {
        isAsync: false,
        name: null
    })}{}`).join(`,${_}`)}],` : ""}${n2}`;
...
var getStarExcludesBlock = (starExcludes, t, {
    _,
    cnst,
    getObject,
    n: n2
}) => starExcludes ? `${n2}${t}${cnst} _starExcludes${_}=${_}${getObject([...starExcludes].map((property) => [property, "1"]), {
    lineBreakIndent: {
        base: t,
        t
    }
})};` : "";
var getImportBindingsBlock = (importBindings, t, {
    _,
    n: n2
}) => importBindings.length > 0 ? `${n2}${t}var ${importBindings.join(`,${_}`)};` : "";
var getHoistedExportsBlock = (exports, t, snippets) => getExportsBlock(exports.filter((expt) => expt.hoisted).map((expt) => ({
    name: expt.exported,
    value: expt.local
})), t, snippets);
...
function getExportsBlock(exports, t, {_, n: n2}) {
    ...
    return `exports({${n2}` + exports.map(({
                                               name,
                                               value
                                           }) => `${t}${name}:${_}${value}`).join(`,${n2}`) + `${n2}});${n2}${n2}`;
}

var getSyntheticExportsBlock = (exports, t, snippets) => getExportsBlock(exports.filter((expt) => expt.expression).map((expt) => ({
    name: expt.exported,
    value: expt.local
})), t, snippets);
var getMissingExportsBlock = (exports, t, snippets) => getExportsBlock(exports.filter((expt) => expt.local === MISSING_EXPORT_SHIM_VARIABLE).map((expt) => ({
    name: expt.exported,
...
function umd(magicString, {
    ...
    if (noConflict) {
        ...
        iifeExport = `(${getFunctionIntro([], {
            isAsync: false,
            name: null
        })}{${n2}${t}${t}${cnst} current${_}=${_}${safeAccess(name, globalVariable, snippets)};${n2}${t}${t}${factory}${n2}${t}${t}${noConflictExportsVariable}.noConflict${_}=${_}${getFunctionIntro([], {
            isAsync: false,
            name: null
    ...
    const wrapperIntro = `(${getNonArrowFunctionIntro(wrapperParameters, {
        isAsync: false,
        name: null
    })}{${n2}` + cjsIntro + `${t}typeof ${define}${_}===${_}'function'${_}&&${_}${define}.amd${_}?${_}${define}(${amdParameters}${factoryVariable})${_}:${n2}${t}${iifeStart}${iifeExport}${iifeEnd};${n2}})(${globalArgument}(${getNonArrowFunctionIntro(factoryParameters, {
        isAsync: false,
        name: null
    })}{${useStrict}${n2}`;
...
function resolveIdViaPlugins(source, importer, pluginDriver, moduleLoaderResolveId, skip, customOptions, isEntry, assertions) {
    ...
    if (skip) {
        ...
        replaceContext = (pluginContext, plugin) => ({
            ...pluginContext,
            resolve: (source2, importer2, {
                assertions: assertions2,
                custom,
                isEntry: isEntry2,
                skipSelf
            } = BLANK) => moduleLoaderResolveId(source2, importer2, custom, isEntry2, assertions2 || EMPTY_OBJECT, skipSelf ? [...skip, {
                importer: importer2,
                plugin,
                source: source2
            }] : skip)
...
async function watchInternal(configs, emitter) {
    ...
    await loadFsEvents();
    const {Watcher} = await import("./watch-LPY6XGOK.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-MWF5UPLL.js.map
