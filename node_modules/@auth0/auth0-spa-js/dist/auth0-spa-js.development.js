(function (global, factory) {
    ...
    async function getJSON(url, timeout, audience, scope, options, worker, useFormData) {
        ...
        const _a = response.json, {error: error, error_description: error_description} = _a,
            data = __rest(_a, ["error", "error_description"]), {ok: ok} = response;
        if (!ok) {
    ...
    async function oauthToken(_a, worker) {
        var {
            ...
            useFormData: useFormData
        } = _a, options = __rest(_a, ["baseUrl", "timeout", "audience", "scope", "auth0Client", "useFormData"]);
    ...
    const patchOpenUrlWithOnRedirect = options => {
        const {openUrl: openUrl, onRedirect: onRedirect} = options,
    ...
    class Auth0Client {
        ...
        async loginWithRedirect(options = {}) {
            ...
            const _b = patchOpenUrlWithOnRedirect(options), {
                ...
                fragment: fragment,
                appState: appState
            } = _b, urlOptions = __rest(_b, ["openUrl", "fragment", "appState"]);
            ...
            const _c = await this._prepareAuthorizeUrl(urlOptions.authorizationParams || {}), {url: url} = _c,
        ...
        async handleRedirectCallback(url = window.location.href) {
            ...
            } = parseAuthenticationResult(queryStringFragments.join(""));
        ...
        _buildLogoutUrl(options) {
            ...
            const _a = options.logoutParams || {}, {federated: federated} = _a,
        ...
        async logout(options = {}) {
            const _a = patchOpenUrlWithOnRedirect(options), {openUrl: openUrl} = _a,
        ...
        async _saveEntryInCache(entry) {
            const {id_token: id_token, decodedToken: decodedToken} = entry,
